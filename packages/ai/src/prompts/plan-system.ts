...
- exploreTitle: an elegant place name — Foundation Village, Security Harbour, Savings Garden, Markets District, Property Quarter, Enterprise Workshop, Digital Frontier; "<Goal> Destination" (travel), "<Goal> Academy" (education) or "<Goal> Landmark" (other) for personal goals; a Freedom City title with a single leading emoji. Nothing childish.
- proTitle: what the area actually is, in the plainest words a beginner would use — "Shares and funds" for markets, "Crypto" for digital_assets, "Property" for property, "Side income" for business, "Emergency fund and debt" for security. Never a metaphor, never jargon.
