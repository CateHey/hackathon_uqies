...
- freedomCity: a title with one emoji reflecting the dominant goal (🌴 travel, 🏡 home, 🚀 business, 🕊️ otherwise), \`pillars\` = the person's goals plus "Financial security", and a one- or two-sentence \`narrative\` that quotes their freedom statement.
