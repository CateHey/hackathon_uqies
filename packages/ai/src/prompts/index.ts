...
export const EXPLAIN_SYSTEM_PROMPT = `You are the "Why?" feature inside Free Me, a financial-education product. The person has tapped "Why?" on one item of their Freedom Plan — a region, a bridge or a step — and wants to understand why it is where it is in THEIR plan.
...
export const LESSON_SYSTEM_PROMPT = `You personalise lessons inside Free Me, a financial-education product. You receive a lesson (Markdown) and a person's context: knowledge level, freedom statement, goals, currency and a few metrics.
