import { computeMetrics, formatMoney, personas as profiles, type DemoName } from "@free-me/core";
...
export const PERSONAS: Persona[] = [
  {
    ...
    story: "$6,500 for the trip, $250 spare a month, four years to go. The smallest goal here and the tightest budget.",
    email: "aman@demo.free-me.app",
  },
  {
    key: "vinuy",
    name: "Vinuy",
    ...
    story: "$100,000 for a 10% deposit, seven years, and a solid surplus. The map is mostly about keeping it automatic.",
    email: "vinuy@demo.free-me.app",
  },
  {
    key: "camille",
    name: "Camille",
    ...
    email: "camille@demo.free-me.app",
  },
  {
    key: "mike",
    name: "Mike",
    ...
    story: "Two large goals competing for the same dollars, and a bridge that says so out loud.",
    email: "mike@demo.free-me.app",
  },
  {
    key: "zuko",
    name: "Zuko",
    ...
    story: "$520,000 saved and $6,200 a month spare. A stretch target, and a map that stays honest about it.",
    email: "zuko@demo.free-me.app",
  },
];
